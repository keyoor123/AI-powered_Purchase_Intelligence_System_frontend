    ...
    <div className="agents-page-container animate-fade-in" style={{ paddingBottom: '3rem' }}>
        ...
        <div className="agent-hero-layout" style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
          ...
          <div>
            ...
            <p style={{ color: 'var(--sidebar-text-secondary)', fontSize: '0.95rem' }}>
              Automate procurement analytics and deliver monthly executive intelligence reports directly to your team's inbox.
            </p>
          </div>
        </div>
      </div>
      ...
      {settingsLoading ? (
        ...
        <div className="agent-grid-layout" style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          ...
          {/* Collapsible Monthly Procurement Summary Report Card */}
          <div className="premium-card animate-slide-up" style={{ padding: 0 }}>
            {/* Header section */}
            <div 
              ...
              style={{
                ...
                padding: '1.5rem',
                cursor: 'pointer',
                borderBottom: settingsCollapsed ? 'none' : '1px solid var(--border-color)',
                userSelect: 'none'
              }}
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                <span className={`badge ${settings?.is_enabled ? 'badge-success' : 'badge-danger'}`}>
                  {settings?.is_enabled ? 'Active Agent' : 'Disabled'}
                </span>
                <div>
                  ...
                  <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>
                    Runs autonomously at scheduled intervals to generate and email PDF report summaries.
                  </p>
                </div>
              </div>
              <button 
